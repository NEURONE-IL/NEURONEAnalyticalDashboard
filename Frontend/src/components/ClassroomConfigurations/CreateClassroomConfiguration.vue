<template>
    ...
    <v-row no-gutters>
      <v-col cols="12" class="text-center">
				...
				<v-divider></v-divider>	
				<br>	
				<!-- Button to set and modify the nodes chart, disabled when at least one CreateClassroomConfiguration form field is invalid or there are 
				not participants -->
				<v-btn
					class="mb-4 ms-4"
					color="primary"
				...
				<!-- Button to save the classroom configuration, disabled when at least one CreateClassroomConfiguration form field is invalid, there are 
...
export default {
	...
	*/
	...
	methods: {
		/*
		@fvillarrealcespedes:
		Sets the data for the nodes chart, disposes the previous nodes chart if exists and finally sets the new one with the data array previously 
		created. 
		*/
		setClassroom(){		
			var data = [];
		...
		/*
		@fvillarrealcespedes:
		Sets the data for the nodes chart, in a for loop composes the data objects and finally pushes them into the data array param. 		
		*/
		...
		/*
		@fvillarrealcespedes:
		Sets the height for the nodes chart depending of the users quantity.
		*/
		setHeight(){
		...
		*/
		...
		/*
		@fvillarrealcespedes:
		Sends a request to create a new classroom configuration. First the height and width properties are taken from the nodes chart HTML div, then 
		sets the positions property by getting all nodes x and y properties from the nodes chart. Finally composes the data object with the three 
		mentioned properties, and the name, createdBy and participants propeties from the component data. 
		*/
